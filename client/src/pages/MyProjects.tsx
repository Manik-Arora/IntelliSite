        ...
        {loading ? (
          ...
          <div className="py-10 min-h-[80vh]">
            <div className="flex items-center justify-between mb-12">
              ...
              <button
                onClick={() => navigate("/")}
                className="flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-r from-indigo-500 to-indigo-600 hover:opacity-90 active:scale-95 transition-all"
              >
                <PlusIcon size={18} />
                Create New
              </button>
                  ...
                  <div className="relative w-full h-40 bg-gray-900 overflow-hidden border-b border-gray-800">
                    {project.currentCode ? (
                      <iframe
                        ...
                        sandbox="allow-scripts allow-same-orgin"
